...
#pragma pack()
	...
	/// <summary> Gets a flag to show whether the KIM101 stage type is supported. </summary>
	/// <param name="serialNo">	The device serial no. </param>
	/// <seealso cref="KIM_SetStageType(char const * serialNo, KIM_Stages stageType)" />
	/// <seealso cref="KIM_RequestStageType(char const * serialNo)" />
	/// <seealso cref="KIM_GetStageType(char const * serialNo)" />
	/// <returns> true if <see cref="KIM_GetStageType(char const * serialNo)" /> is supported. </returns>
	KCUBEINERTIALMOTOR_API bool __cdecl KIM_SupportsStageType(char const * serialNo);

	/// <summary> Gets the KIM101 stage type. </summary>
	/// <param name="serialNo">	The device serial no. </param>
	/// <seealso cref="KIM_SetStageType(char const * serialNo, KIM_Stages stageType)" />
	/// <seealso cref="KIM_RequestStageType(char const * serialNo)" />
	/// <seealso cref="KIM_SupportsStageType(char const * serialNo)" />
	/// <returns> The stage type. </returns>
	KCUBEINERTIALMOTOR_API KIM_Stages __cdecl KIM_GetStageType(char const * serialNo);

	/// <summary> Sets the KIM101 stage type. </summary>
	/// <param name="serialNo">	The device serial no. </param>
	...
	/// <seealso cref="KIM_SupportsStageType(char const * serialNo)" />
	/// <returns> The error code (see \ref C_DLL_ERRORCODES_page "Error Codes") or zero if successful. </returns>
	KCUBEINERTIALMOTOR_API short __cdecl KIM_SetStageType(char const * serialNo, KIM_Stages stageType);

	/// <summary> Request KIM101 stage type. </summary>
	/// <param name="serialNo">	The device serial no. </param>
	/// <seealso cref="KIM_SetStageType(char const * serialNo, KIM_Stages stageType)" />
	/// <seealso cref="KIM_GetStageType(char const * serialNo)" />
	/// <seealso cref="KIM_SupportsStageType(char const * serialNo)" />
	/// <returns> The error code (see \ref C_DLL_ERRORCODES_page "Error Codes") or zero if successful. </returns>
	KCUBEINERTIALMOTOR_API short __cdecl KIM_RequestStageType(char const * serialNo);
